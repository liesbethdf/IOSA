...
A clear external transition risk faced by the South African economy under a BAU versus a 2DS scenario, is the difference in global demand for coal under both scenarios. CPI's models estimate that the volume of coal exported by South Africa over the period 2018-2035 under a 2DS is about half the volume expected under BAU. Moreover, the price on the global market is expected to be lower under 2DS. 
...
\begin{table}[ht]
	...
	\begin{tabular}{lclc}
		...
		Coal and lignite & 21 &  Coal &  16.6    \\
	 	Electricity, gas and water & 41 &  & 5.2     \\
