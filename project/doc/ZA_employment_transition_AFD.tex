...
From the macroeconomic perspective, the coal sector is thus, compared to other sectors, or the South African economy in general, not a big generator of jobs. The numbers given above already established that the sector is capital intensive, consequently, the labour share is relatively low, explaining the much lower contribution of coal export to employment than to GDP. Figure 
