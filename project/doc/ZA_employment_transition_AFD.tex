...
\defcitealias{MineralsCouncil2018Facts}{Minerals Council, 2018}
...
The methodology here used allows to take into account, on the macro-level, how one sector's demand or price influences the rest of the economy. The information needed to perform such an analysis %take into account these dependencies 
...
% 23295 jobs sustained by coal needs other industry
% gross operating surplus coal 41.3 % of total coal revenue
...
%
%
%\li{Description of the coal sector within the economy as job creator.}
%
...
%x\% of the jobs created by coal export is thus in sectors with higher employment than the economy's average.
