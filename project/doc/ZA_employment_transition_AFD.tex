...
Export and import volumes and prices do not only impact the growth and profitability of the sector doing the exporting and importing, but also impact the rest of the economy because commodities are made in value chains, linking industries together through procurement relationships. The first will be referred to as the direct and the latter as the indirect effects. The methodology used for the analysis on the macro-level allows to take into account both of these.%, based on the latest input-output table takes into account not only the direct effect on a sector of the demand it faces, but also the indirect effects
