...
CPI's projections for coal export towards 2035, i.e. towards the end of the period under study, are 90\% lower under 2DS than under BAU. They project that the coal sector, thanks to sustained local demand mainly from electricity production, can support about 30 000 jobs on the long term.% towards the end of the period under consideration.
