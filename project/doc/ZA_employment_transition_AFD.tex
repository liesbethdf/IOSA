...
In terms of employment, about 81.827 jobs would be lost 

We here focus on the difference in employment and wages between the two scenarios. The yearly employment estimates are based on the assumption is that the number of employees per unit of output is also constant throughout the period and equal to figures for 2014.
...
Table \ref{coalExport_BAUvs2DS_2035_table_employment}
