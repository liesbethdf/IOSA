...
A clear external transition risk faced by the South African economy under a BAU versus a 2DS scenario, is the difference in global demand for coal both scenarios imply. CPI's models estimate that the volume of coal exported by South Africa over the period 2018-2035 under a 2DS is about half the volume expected under BAU. Additionally, the price on the global market is expected to be lower under 2DS. 
...
\begin{table}[ht]
	...
	\begin{tabular}{lclc}
		...
		\midrule
		Coal and lignite & 21 &  Coal &  16.6    \\
		Electricity, gas and water & 41 & Coal, other & 5.2     \\
		Generation &41111 & Other &     \\
		Gas &412 & Other &     \\
		 &remaining & Coal, other &     \\
		Transport &71 \& 74 &  Coal  &   2.4   \\
		Coke oven manufacture & 331 \& 332 & Coal &  1.6 \\
		Nuclear fuel & 333 \& 334 & Other & 0.1   \\
		Other mining &  25 & Other &   0.06 \\
%		 &    &    \\
		\bottomrule
	\end{tabular}
	\caption{\label{GenerationMixcoefficients}The technical coefficients of the Leontief matrix that capture the generation mix. Eskom's Primary energy cost breakdown 2014, million Rand. Source : \href{http://www.eskom.co.za/IR2015/Documents/EskomIR2015single.pdf}{Integrated report}, \citep{Eskom2014AR}.}
\end{table}
...
\begin{table}[ht]
	...
	\begin{tabular}{lrrl}
		\toprule
		%\midrule
		Primary energy source	& Cost, mR  & Cost, \% & IOT  \\ 
		\midrule
		...
		Environmental levy & 8353 &   10.0   & Taxes \\
